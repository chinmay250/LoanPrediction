...
def predict():
	if request.method == 'POST':
		...
		if int(result) == 1:
			prediction = 'Dear {name}, your loan for {loan_amount} $ is approved!'.format(name = name,loan_amount=loan_amount)
		else:
			prediction = 'Sorry {name}, your loan for {loan_amount} $ is rejected!'.format(name = name,loan_amount=loan_amount)
